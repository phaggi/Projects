...
#define PORT_POWER_SENSOR1		2
#define PORT_POWER_SENSOR2		3
#define PORT_POWER_SENSOR3		4
#define PORT_POWER_SENSOR4		5

#define PORT_ANALOG_SENSOR1		0
#define PORT_ANALOG_SENSOR2		1
#define PORT_ANALOG_SENSOR3		2
#define PORT_ANALOG_SENSOR4		3

#define SENSOR_NUMB				    4
#define SENSOR_PRESENT			  [SENSOR1, SENSOR2, SENSOR3, SENSOR4]
#define PORT_POWER_SENSOR		  [PORT_POWER_SENSOR1, PORT_POWER_SENSOR2, PORT_POWER_SENSOR3, PORT_POWER_SENSOR4]
